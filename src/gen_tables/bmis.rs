...
use crate::gen_tables::magic_helpers::{NUM_MOVES, magic_mask, questions_and_answers};
...
static mut BISHOP_BMI_MASK: [BmiMagic; 64] = [BmiMagic { blockers_mask: EMPTY, offset: 0 }; 64];

static mut ROOK_BMI_MASK: [BmiMagic; 64] = [BmiMagic { blockers_mask: EMPTY, offset: 0 }; 64];
